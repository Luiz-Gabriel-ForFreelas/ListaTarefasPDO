	...
	<head>
		...
		<script>
			function editar(id, descricao){
				...
				//criar input hidden para guardar o id
			...
			function remover(id){
				document.location = 'index.php?pag=index&acao=remover&id='+id
			}

			function marcarRealizada(id){
				document.location = 'index.php?pag=index&acao=marcarRealizada&id='+id
			}
		</script>
	</head>
